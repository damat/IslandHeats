const messages = {
  ru: {
    ...
    pricingFullCourt1: '600 бат на месте — 90 минут',
    pricingFullCourt2: '900 бат — 2 часа',
    pricingFullCourt3: 'Если людей больше 6 — всё равно полный выкуп корта',
    ...
    priceHintText:
      '90 мин — 100 бат с человека, 2 часа — 150 бат. Для сессии с тренером тренер тоже входит в расчёт (+1), но в число игроков не добавляется. 6+ человек: 600 бат за 90 мин / 900 бат за 2 часа.',
  ...
  en: {
    ...
    pricingFullCourt1: '600 THB on the spot — 90 minutes',
    pricingFullCourt2: '900 THB — 2 hours',
    pricingFullCourt3: 'If more than 6 people — still full court rental',
    ...
    priceHintText:
      '90 min — 100 THB per person, 2 hours — 150 THB. For a coach session the coach is included in the price (+1) but not in the player count. 6+ people: 600 THB for 90 min / 900 THB for 2 hours.',
  ...
  th: {
    ...
    pricingFullCourt1: '600 บาทที่สนาม — 90 นาที',
    pricingFullCourt2: '900 บาท — 2 ชม.',
    pricingFullCourt3: 'ถ้ามากกว่า 6 คน — ยังคิดเป็นเช่าสนามทั้งหมด',
    ...
    priceHintText:
      '90 นาที — 100 บาทต่อคน, 2 ชม. — 150 บาท เซสชันกับโค้ชคิดโค้ชในราคา (+1) แต่ไม่นับในจำนวนผู้เล่น 6+ คน: 600 บาท 90 นาที / 900 บาท 2 ชม.',
